...
<?php
 ...
 echo "<tr>
    ...
    <td>$cs</td>
	<td>$ename</td>
	<td><a href='updateexam.php?rn=$row[cs]&fn=$row[ename]'><button name='submit'><i class='fas fa-check-circle'></i></button>
	<button><a href='delete1.php?rn=$row[cs]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
	echo "</table>";
?>
