...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="wrapper">
			...
			<form class="contact-form" action="addstudent.php" method="post">
            <h1>Add Student </h1>
            <div class="border"></div>
            
            <select class="contact-form-text" placeholder="Enter class and section" name="cs">
<?php
     include("conection.php");
     $sql="select class_name,sec from createclass";
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='Class:$type Sec:$type2' name='cs'>Class Name:$type and section:$type2</option>";
    }
?>
</select>
    <select type="text" name="id" class="contact-form-text" placeholder="Enter student id">
    <?php
     include("conection.php");
     $sql="select S_ID from registration";
     $r=mysqli_query($con,$sql);
    ...
    while($row=mysqli_fetch_array($r))
    {
       ...
       // $type2=$row['section'];
        ...
        echo "<option value='$type' name='id'>$type </option>";
    }
?>
</select>
     <select type="text" name="session" class="contact-form-text" placeholder="session f.e 2018">
        <?php
     include("conection.php");
     $sql="select distinct session from addcomsub";
     $r=mysqli_query($con,$sql);
    ...
    while($row=mysqli_fetch_array($r))
    {
       ...
       // $type2=$row['section'];
        ...
        echo "<option value='$type' name='session'>$type </option>";
    }
?>
...
if(isset ($_POST['submit']))
{
    ...
    $query="insert into student values('$cs','$sid','$session')";
