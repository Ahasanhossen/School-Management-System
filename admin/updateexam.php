    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updateexam.php" method="post">
                    <h1>Update Exam</h1>
 ...
 $r=mysqli_query($con,$sql);
  ...
  echo "<option value='$rn'>$rn</option>";
    while($row=mysqli_fetch_array($r))
    {
      ...
      echo "</select>";
      ?>
      <select type="text" value="<?php echo "$fn" ?>" name="ename" class="contact-form-text" placeholder="Enter exam name">
        <option value="<?php echo "$fn" ?>"><?php echo "$fn" ?></option>
        <option value="First Term">First Term</option>
        <option value="Mid Term">Mid Term</option>
        <option value="Final">Final</option>
      </select>
                            
                      <input type="text" value="<?php echo "$rn" ?>" name="pcs" class="contact-form-text" placeholder="Enter class and section" readonly hidden>
                      <input type="text" value="<?php echo "$fn" ?>" name="pename" class="contact-form-text" placeholder="Enter exam name" hidden>
...
if($_POST['submit'])
{
	...
	$query = "update createexam set cs='$cs',ename='$ename' where cs='$pcs' and ename='$pename'";
