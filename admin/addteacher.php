        ...
        $(document).ready(function(){
           ...
           <div class="main-container">
            <div class="card">
                ...
                <form class="contact-form" action="addteacher.php" method="post">
                    <h1>Add Teacher</h1>
                    <div class="border"></div>

                      <input type="text" name="tname" class="contact-form-text" placeholder="Enter Teacher Name">
                      <input type="text" name="tid" class="contact-form-text" placeholder="Enter Teacher Id">
                      <input type="Password" name="pass" class="contact-form-text" placeholder="Enter Password">
...
if(isset ($_POST['submit']))
{
    ...
    $query="insert into teacher values('$tname','$tid','$pass')";
