    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updateclass.php" method="post">
                    <h1>Update Student Class</h1>
                    <div class="border"></div>
                    <select type="text" name="classname" class="contact-form-text"><option selected value="<?php echo "$rn" ?>"><?php echo "$rn" ?></option>
                      ...
                      <select type="text" name="cnumeric" class="contact-form-text"><option selected value="<?php echo "$fn" ?>"><?php echo "$fn" ?></option>
                    ...
                    <select type="text" name="sec" class="contact-form-text"><option selected  value="<?php echo "$gn" ?>"><?php echo "$gn" ?></option>
                      ...
                      <input type="text" value="<?php echo "$rn" ?>" name="pclassname" class="contact-form-text" placeholder="Enter class name" hidden>
                      <input type="text" value="<?php echo "$fn" ?>" name="pcnumeric" class="contact-form-text" placeholder="Enter class name in numeric" hidden>
                      <input type="text" value="<?php echo "$gn" ?>" name="psec" class="contact-form-text" placeholder="Enter Section" hidden>
...
if($_POST['submit'])
{
	...
	$cnumeric = $_POST['cnumeric'];
	$sec = $_POST['sec'];
    $pcname = $_POST['pclassname'];
    $pcnumeric = $_POST['pcnumeric'];
    $psec = $_POST['psec'];
	$query = "update createclass set class_name='$cname',cnumeric='$cnumeric',sec='$sec' where cnumeric='$pcnumeric' and sec='$psec' and class_name='$pcname' ";
