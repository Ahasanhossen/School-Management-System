...
<html lang="en" dir="ltr">
	<head>
        <meta charset="utf-8">
        <title>Update Teacher Course</title>
	...
	<body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="update_tcourses.php" method="post">
                    <h1>Update Teacher Course</h1>
                    <div class="border"></div>                    
                      
                      <input type="text" value="<?php echo "$rn" ?>" name="id" class="contact-form-text" placeholder="Enter class and section" readonly>
                      <input type="text" value="<?php echo "$fn" ?>" name="name" class="contact-form-text" placeholder="Enter exam name" readonly>
					  
				<select class="contact-form-text" placeholder="Enter class" name="class">
                       
                  <!-- <input type="text" value='<?php //echo "$gn" ?>' name="cs" class="contact-form-text" placeholder="Enter class and section">-->
...
<?php
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     ...
     //<select name='class'>";
     $sql="select distinct cs from addcomsub ";
...
?>
		...
		<select class="contact-form-text" placeholder="Enter class" name="subject">
                     ...
                     <!-- <input type="text" value="<?php //echo "$hn" ?>" name="subject" class="contact-form-text" placeholder="Enter exam name">-->
<?php
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     ...
     //<select name='subject'>";
     $sql="select distinct ssub from addcomsub ";
     $r=mysqli_query($con,$sql);
  ...
  echo "<option value='$hn'>$hn</option>";
    while($row=mysqli_fetch_array($r))
    {
      ...
      ?>
                      ...
                      <input type="text" value="<?php echo "$hn" ?>" name="psubject" class="contact-form-text" placeholder="Enter exam name" hidden>
                      <input type="text" value="<?php echo "$gn" ?>" name="pclass" class="contact-form-text" placeholder="Enter exam name" hidden>
...
if($_POST['submit'])
{
	...
	$query = "update teacher_course set class='$class',subject_name='$subject' where T_ID='$id' and subject_name='$psubject' and class='$pclass' ";
