...
<form class="contact-form" action="createexam.php" method="post">
...
<?php
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='Class:$type Sec:$type2' name='cs'>Class Name: $type & section: $type2</option>";
    }
?>
</select>
    <select type="text" name="ename" class="contact-form-text" placeholder="Enter exam name">
        <option selected="selected" disabled="disabled">Select Exam Type</option>
...
if(isset ($_POST['submit']))
{
	...
	$query="insert into createexam values('$cs','$ename')";
