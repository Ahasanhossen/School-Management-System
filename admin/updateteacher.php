    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updateteacher.php" method="post">
                    <h1>Update Teacher</h1>
                    <div class="border"></div>
                     <input type="text" value="<?php echo "$rn" ?>" name="id" class="contact-form-text" placeholder="Enter class and section" readonly>
                      <input type="text" value="<?php echo "$fn" ?>" name="tname" class="contact-form-text" placeholder="">
                       <input type="text" value="<?php echo "$hn" ?>" name="pass" class="contact-form-text" placeholder="">                     
...
if($_POST['submit'])
{
	...
	$query = "update teacher set T_name='$name',password='$pass' where T_ID='$id'";
