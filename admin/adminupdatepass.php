...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Admin Update Pass</title>
        <link rel="stylesheet" href="../css/adminupdatepass.css">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="adminupdatepass.php" method="post">
                    <h1>Admin Change Password</h1>
                    <div class="border"></div>
                      <input type="password" name="opass" class="contact-form-text" placeholder="Enter current password">
                      <input type="password" name="npass" class="contact-form-text" placeholder="Enter new password">
                      <input type="password" name="cpass" class="contact-form-text" placeholder="Confirm password">
...
<?php
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($npass == $cpass) {
                $sql = "select Password from admin where Password='$opass' and ID='$email'";
                $r1 = mysqli_query($con, $sql);
                if (mysqli_num_rows($r1) > 0) {
                    $sql1 = "update admin set Password='$npass' where ID='$email'";
                    if (mysqli_query($con, $sql1)) {
                        echo "Password Changed Successfully!";
						header('Location:adminupdatepass.php');
						}
                } else {
