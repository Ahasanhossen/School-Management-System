...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Update Sbj-Combination</title>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updatesubcom.php" method="post">
 ...
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     echo "
     <select type='text'value='$rn' name='cs' class='contact-form-text'>";
 ...
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     echo "
     <select type='text'value='$fn' name='ssub' class='contact-form-text'>";
  ...
  echo "<option value='$fn'>$fn</option>";
    while($row=mysqli_fetch_array($r1))
    {
      ...
      ?>
                      ...
                      <input type="text" value="<?php echo "$rn" ?>" name="sname" class="contact-form-text" placeholder="Enter Class Name and section" readonly hidden>
                      <input type="text" value="<?php echo "$fn" ?>" name="scode" class="contact-form-text" placeholder="Enter Subject" hidden>                     
...
if($_POST['submit'])
{
	...
	$query = "update addcomsub set cs='$cs',ssub='$ssub' where ssub='$ssub'";
	$data = mysqli_query($con,$query);
	
	if($data)
	{
		echo "<script>alert('Record Updated')
        window.location.href = 'managesubcom.php'</script>";
