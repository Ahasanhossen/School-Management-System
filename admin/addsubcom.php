...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <form class="contact-form" action="addsubcom.php" method="post">
            <select class="contact-form-text" placeholder="Select Class" name="cs">
<?php
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='Class:$type Sec:$type2' name='cs'>Class:$type and section $type2</option>";
    }
?>
</select>
<select class="contact-form-text" placeholder="Select Subject" name="ssub">
<?php
     include("conection.php");
     $sql="select sname from createsub";
     $r=mysqli_query($con,$sql);
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='$type3' name='ssub'>$type3</option>";
    }
?>
</select>
<input type="text" name="session" placeholder="session F.E 2018" class="contact-form-text">
...
if(isset ($_POST['submit']))
{
	...
	$query="insert into addcomsub values('$cs','$ssub','$session')";
	if(mysqli_query($con,$query))
	{
		echo "Successfully inserted!";
		header('Location:addsubcom.php');
    }
	else
	{
