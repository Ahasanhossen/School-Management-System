                ...
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="subjects">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="managesub.php"><i class="fas fa-tasks"></i></i><span>Manage Sbj-Combination</span></a>
                        </div>
                    </li>
                    ...
                    <li class="item" id="students">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="mangage_teacher.php"><i class="fas fa-image"></i><span>Mnage Teacher</span></a>
...
//$id=$_SESSION['teacher_id'];
 $sql="select subject_name from result ";
 $r=mysqli_query($con,$sql);
    ...
    echo "<input type='submit' name='gog' value='submit' class='contact-form-btn'";
   echo("</from>");
 }*/
 ?>--->
 <?php
 ...
 if(isset($_POST['gog']))
  {
    echo "<form action='result_pdf.php?action=add' id='in' method='POST'>";
    $class=$_POST['class'];
     $exam=$_POST['exam'];
...
if ($total<40) {
  ...
  echo "<form action='result_pdf.php?action=add' id='in' method='POST'>";  
   ...
   echo " <input type='submit' name='submit' class='contact-form-btn 'value='Save'>";
    // echo "</form>";
     echo "<input type='text' name='class'  value='$class' readonly hidden >";
     echo "<input type='text' name='subject'  value='$subject' readonly hidden >";
     echo "<input type='text' name='ename'  value='$exam' readonly hidden >";
