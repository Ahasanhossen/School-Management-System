...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="../css/createsub.css">
        ...
        <div class="wrapper">
            ...
            <div class="card">
                <div class="contact-section">
                    <form class="contact-form" action="createsub.php" method="post">
                    <h1>Create Subject</h1>
                    <div class="border"></div>
                      <input type="text" name="sname" class="contact-form-text" placeholder="Enter Subject Name">
                      <input type="text" name="scode" class="contact-form-text" placeholder="Enter Subject Code">                      
...
if(isset ($_POST['submit']))
{
	...
	$query="insert into createsub values('$sname','$scode')";
