...
<?php
 ...
 echo "<tr>
    ...
    echo "<tr>
    <td>$T_ID</td><td>$T_name</td><td>$password</td><td><a href='updateteacher.php?rn=$row[T_ID]&fn=$row[T_name]&hn=$row[password]'><button name='submit'><i class='fas fa-check-circle'></i></button>
    <button><a href='delete4.php?rn=$row[T_ID]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
	echo "</table>";
?>
