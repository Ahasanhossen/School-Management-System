...
<html lang="en" dir="ltr">
 ...
 echo "<tr>
	...
	<td>$cnumeric</td>
	<td>$sec</td>
	<td><a href='updateclass.php?rn=$row[class_name]&fn=$row[cnumeric]&gn=$row[sec]'><button name='submit'><i class='fas fa-check-circle'></i></button>
	<button><a href='delete.php?rn=$row[cnumeric]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
	echo "</table>";
?>
