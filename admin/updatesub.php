...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updatesub.php" method="post">
 ...
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     echo "
     <select type='text'value='$rn' name='sname' class='contact-form-text'>";
     $sql="select distinct sname from createsub ";
 ...
 include("conection.php");
  ...
  //echo "<form action='addresult.php?action=gog' id='in' method='POST'>";
     echo "
     <select type='text'value='$fn' name='scode' class='contact-form-text'>";
     $sql2="select distinct scode from createsub ";
  ...
  echo "<option value='$fn'>$fn</option>";
    while($row=mysqli_fetch_array($r1))
    {
      ...
      ?>
                      ...
                      <input type="text" value="<?php echo "$rn" ?>" name="psname" class="contact-form-text" placeholder="Enter Subject Name" readonly hidden>
                      <input type="text" value="<?php echo "$fn" ?>" name="pscode" class="contact-form-text" placeholder="Enter Subject Code" hidden>                     
...
if($_POST['submit'])
{
	...
	$query = "update createsub set sname='$sname',scode='$scode' where sname='$psname' and scode='$pscode'";
