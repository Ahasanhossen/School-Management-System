...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Mange Subject Combination</title>
...
<?php
 ...
 $sql="select * from addcomsub";
 $r=mysqli_query($con,$sql);
 echo "<table id='customers'>";
 echo "<tr>
    <th>Class name and section</th>
    <th>Subject</th>
	<th>Subject</th>
    <th>Action</th>
  </tr>";
	...
	<td>$ssub</td>
	<td>$session</td>
	<td><a href='updatesubcom.php?rn=$row[cs]&fn=$row[ssub]'><button name='submit'><i class='fas fa-check-circle'></i></button>
	<button><a href='delete3.php?rn=$row[ssub]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
	echo "</table>";
?>
