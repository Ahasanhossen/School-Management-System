            ...
            <div class="card">
                ...
                <form class="contact-form" action="createclass.php" method="post">
                    ...
                    <div class="border"></div>               
                      <input type="text" name="cname" class="contact-form-text" placeholder="Enter class name">
                      <input type="text" name="cnumeric" class="contact-form-text" placeholder="Enter class name in numeric">
                      <input type="text" name="sec" class="contact-form-text" placeholder="Enter section">
...
if(isset ($_POST['submit']))
{
	...
	$query="insert into createclass values('$cname','$cnumeric','$sec')";
