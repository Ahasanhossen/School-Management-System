...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>Teacher Course Assign</title>
        ...
        $(document).ready(function(){
           ...
           <div class="main-container">
            <div class="card">
                ...
                <form class="contact-form" action="teachercourse.php" method="post">
                    <h1>Teacher Course</h1>
                    <div class="border"></div>

                        <?php
                   echo"<select class='contact-form-text' placeholder='Enter class and section' name='id'>";
...
echo"</select>";
    echo" <select class='contact-form-text' placeholder='Enter class and section' name='tname'>";
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='$T_name' name='id'>$T_name</option>";
    }
    echo"</select>";

 echo" <select class='contact-form-text' placeholder='Enter class and section' name='class'>";
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='$class' name='id'>$class</option>";
    }
    echo"</select>";
echo"</select>";

 echo" <select class='contact-form-text' placeholder='Enter class and section' name='sub'>";
    ...
    while($row=mysqli_fetch_array($r))
    {
        ...
        echo "<option value='$sub' name='id'>$sub</option>";
    }
    echo"</select>";
?>
...
if(isset ($_POST['submit']))
{
    ...
    $tname=$_POST['tname'];
      $class=$_POST['class'];
     $sub=$_POST['sub'];
    $query="insert into teacher_course values(' $tid','$tname','$class','$sub')";
    ...
    window.location.href = 'teachercourse.php'
</script>   ";
