...
<html lang="en" dir="ltr">
 ...
 echo "<tr>
    ...
    <td>$class</td>
    <td>$subject</td>
    <td><a href='update_tcourses.php?rn=$row[T_ID]&fn=$row[T_name]&gn=$row[class]&hn=$row[subject_name]'><button name='submit'><i class='fas fa-check-circle'></i></button>
    <button><a href='delete5.php?rn=$row[T_ID]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
    echo "</table>";
?>
