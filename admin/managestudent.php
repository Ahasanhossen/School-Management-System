...
<?php
 ...
 echo "<tr>
	...
	<td>$sid</td>
	<td>$session</td>
	<td><a href='updatestudent.php?rn=$row[class]&fn=$row[sid]&gn=$row[session]'><button name='submit'><i class='fas fa-check-circle'></i></button>
	<button><a href='delete6.php?rn=$row[sid]'><i class='fas fa-times-circle'></i></button></td>
    </tr>";
    }
	echo "</table>";
?>
