    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="card">
                ...
                <form class="contact-form" action="updateteapass.php" method="post">
...
<?php
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($npass == $cpass) {
                $sql = "select password from teacher where password='$opass' and T_ID='$email'";
                $r1 = mysqli_query($con, $sql);
                if (mysqli_num_rows($r1) > 0) {
                    $sql1 = "update teacher set password='$npass' where T_ID='$email'";
                    if (mysqli_query($con, $sql1)) {
                        echo "Password Changed Successfully!";
						header('Location:updateteapass.php');
						}
                } else {
