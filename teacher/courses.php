...
$ids=$_SESSION['teacher_id'];
//echo " <input type='text' value='$ids' name='pass' class='contact-form-text' placeholder=''>";
$sql="select * from teacher_course where T_ID='$ids'";
$r=mysqli_query($con,$sql);
 ...
 <th>Session</th>
  ...
  while($row=mysqli_fetch_array($r))
    ...
    //$total=$row['mark'];
     echo "<tr>
    <td>$subject</td><td>$class</td><td>$session</td>
